...
| image_caption | string | optional | *(generated by BLIP)* | Caption of product region (detect-then-caption pipeline); appended to search text |
| detection_confidence | float | optional, 0–1 | *(generated by OWL-ViT)* | OWL-ViT confidence score for detected product region; `null` if detection fell back to full image. Useful for quality filtering. |
